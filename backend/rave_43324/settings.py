"""
Django settings for rave_43324 project.
...
WSGI_APPLICATION = 'rave_43324.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rave_43324 API",
    "DESCRIPTION": "API documentation for rave_43324 App",
    "VERSION": "v1",
}
